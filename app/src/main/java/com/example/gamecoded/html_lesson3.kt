...
class HtmlLesson3 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_html_lesson3)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.activity_html_lesson3)) { v, insets ->
        ...
        val dragH1 = findViewById<TextView>(R.id.drag_h1_tag)

        val dropPara = findViewById<LinearLayout>(R.id.drop_para)
        val dropHeading = findViewById<LinearLayout>(R.id.drop_heading)
        ...
        listOf(dragP, dragH1).forEach { it.setOnLongClickListener(dragStarter) }
        ...
        listOf(dropPara, dropHeading).forEach { it.setOnDragListener(dropListener) }
        ...
        btn.setOnClickListener {
            ...
            if (id == -1) {
                ...
                tvResult.text = if (selected == "<p>") "✅ Correct!" else "❌ Try again."
            }
        }
    }
}